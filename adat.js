    ...
    songs: [
      {
        ...
        cardsData: [
          { keyword: "Call", keywordHungarian: "hív, nevez, elnevez", english: "I **call** my friend today.", hungarian: "Ma felhívom a barátomat.", startTime: 27.4, endTime: 30.4, verseIndex: 0 },
          { keyword: "Name", keywordHungarian: "elnevez / név", english: "What is your **name**, please?", hungarian: "Mi a neved, kérlek?", startTime: 33.8, endTime: 37.0, verseIndex: 0 },
          ...
          { keyword: "Generation", keywordHungarian: "generáció", english: "Every **generation** walks this way.", hungarian: "Minden **generáció** erre jár.", startTime: 47.5, endTime: 50.9, verseIndex: 1 },
          { keyword: "Human", keywordHungarian: "emberi lény / ember", english: "Every **human** needs a rest.", hungarian: "Minden embernek szüksége van pihenésre.", startTime: 55.6, endTime: 58.9, verseIndex: 2 },
          { keyword: "ID / ID card", keywordHungarian: "személyi igazolvány (ID)", english: "Show me your **ID** right now.", hungarian: "Mutasd meg a személyidet most.", startTime: 62.3, endTime: 65.6, verseIndex: 2 },
          { keyword: "Initial", keywordHungarian: "kezdőbetű / monogram", english: "I write my **initials** on the wall.", hungarian: "Felírom a monogramomat a falra.", startTime: 89.2, endTime: 92.6, verseIndex: 4 },
          { keyword: "Lady", keywordHungarian: "hölgy", english: "That **lady** has a yellow bag.", hungarian: "Annak a **hölgy**nek sárga táskája van.", startTime: 96, endTime: 99.0, verseIndex: 4 },
          { keyword: "Madam", keywordHungarian: "asszonyom", english: "Good morning, **madam**, how are you?", hungarian: "Jó reggelt, **asszonyom**! Hogy van?", startTime: 103.4, endTime: 106.7, verseIndex: 5 },
          { keyword: "Sir", keywordHungarian: "uram", english: "Thank you for the coffee, **sir**.", hungarian: "Köszönöm a kávét, **uram**.", startTime: 109.8, endTime: 113.6, verseIndex: 5 },
          { keyword: "Youth", keywordHungarian: "fiatalság / fiatalok", english: "Keep your **youth** alive and bold.", hungarian: "Őrizd meg a fiatalságodat és légy bátor.", startTime: 138.6, endTime: 141.8, verseIndex: 7 },
          { keyword: "Divorced", keywordHungarian: "elvált", english: "That **divorced** man walks alone.", hungarian: "Az az **elvált** férfi egyedül sétál.", startTime: 145, endTime: 148.5, verseIndex: 7 },
          { keyword: "Elderly", keywordHungarian: "idős", english: "An **elderly** man sits on a chair.", hungarian: "Egy **idős** férfi ül egy széken.", startTime: 153.1, endTime: 156.0, verseIndex: 8 },
          { keyword: "Middle", keywordHungarian: "aged - középkorú", english: "A **middle-aged** woman reads a book.", hungarian: "Egy középkorú nő könyvet olvas.", startTime: 160, endTime: 163.0, verseIndex: 8 },
          { keyword: "Personal", keywordHungarian: "személyes", english: "Keep it **personal** and sweet.", hungarian: "Maradjon **személyes** és kedves.", startTime: 197, endTime: 200.6, verseIndex: 10 },
          { keyword: "Teenage", keywordHungarian: "tizenéves / tinédzser", english: "My **teenage** memories return.", hungarian: "Visszatérnek a tinédzser emlékeim.", startTime: 204.5, endTime: 207.7, verseIndex: 10 },
          { keyword: "Guys", keywordHungarian: "srácok", english: "Hello **guys**, look at the sun!", hungarian: "Sziasztok **srácok**, nézzétek a napot!", startTime: 214, endTime: 217.2, verseIndex: 11 },
          { keyword: "Grow up", keywordHungarian: "felnőni", english: "Where did you **grow up**?", hungarian: "Hol nőttél fel?", startTime: 221, endTime: 225.2, verseIndex: 11 }
        ],

        songStructureData: [
          {
            title: "Verse 1", start: 27.4, end: 40.6,
            lines: [
              { text: "I **call** my friend today.", hungarian: "Ma felhívom a barátomat.", start: 27.4, end: 30.4 },
              { text: "No one has the time to stay.", hungarian: "Senkinek nincs ideje maradni.", start: 30.4, end: 33.8 },
              { text: "What is your **name**, please?", hungarian: "Mi a neved, kérlek?", start: 33.8, end: 37.0 },
              { text: "Everyone hides behind a screen.", hungarian: "Mindenki egy képernyő mögé bújik.", start: 37, end: 40.6 }
            ]
          },
          {
            title: "Verse 2", start: 41.1, end: 54.0,
            lines: [
              { text: "I remember my **childhood** here.", hungarian: "Emlékszem a gyermekkoromra itt.", start: 41.1, end: 44.0 },
              { text: "The old days slowly disappear.", hungarian: "A régi napok lassan eltűnnek.", start: 44, end: 47.5 },
              { text: "Every **generation** walks this way.", hungarian: "Minden generáció erre jár.", start: 47.5, end: 50.9 },
              { text: "But nobody has time to stay.", hungarian: "De senkinek nincs ideje maradni.", start: 50.9, end: 54.0 }
            ]
          },
          {
            title: "Verse 3", start: 55.6, end: 69.1,
            lines: [
              { text: "Every **human** needs a rest.", hungarian: "Minden embernek szüksége van pihenésre.", start: 55.6, end: 58.9 },
              { text: "Still we always chase the best.", hungarian: "Mégis mindig a legjobbat hajszoljuk.", start: 58.9, end: 62.3 },
              { text: "Show me your **ID** right now.", hungarian: "Mutasd meg a személyidet most.", start: 62.3, end: 65.6 },
              { text: "We need a number anyhow.", hungarian: "Valahogy szükségünk van egy számra.", start: 65.6, end: 69.1 }
            ]
          },
          {
            title: "Refrain", start: 69.1, end: 84.7,
            lines: [
              { text: "Walking down the street, FaceApp all around.", hungarian: "Sétálok az utcán, mindenütt FaceApp-os arcok.", start: 69.1, end: 84.7 },
              { text: "Everyone hides the pain they carry around.", hungarian: "Mindenki rejtegeti a fájdalmat, amit magával hord.", start: 69.1, end: 84.7 },
              { text: "I'm hiding all my little scars.", hungarian: "Én is rejtegetem az apró sebeimet.", start: 69.1, end: 84.7 },
              { text: "Maybe it's the fault in our stars.", hungarian: "Talán a csillagainkban van a hiba.", start: 69.1, end: 84.7 }
            ]
          },
          {
            title: "Verse 4", start: 89.2, end: 102.3,
            lines: [
              { text: "I write my **initials** on the wall.", hungarian: "Felírom a monogramomat a falra.", start: 89.2, end: 92.6 },
              { text: "Tomorrow no one cares at all.", hungarian: "Holnap már senkit sem érdekel.", start: 92.6, end: 96.0 },
              { text: "That **lady** has a yellow bag.", hungarian: "Annak a hölgynek sárga táskája van.", start: 96, end: 99.0 },
              { text: "People ignore her as they pass.", hungarian: "Az emberek figyelmen kívül hagyják, miközben elmennek mellette.", start: 99, end: 102.3 }
            ]
          },
          {
            title: "Verse 5", start: 103.4, end: 116.8,
            lines: [
              { text: "Good morning, **madam**, how are you?", hungarian: "Jó reggelt, asszonyom! Hogy van?", start: 103.4, end: 106.7 },
              { text: "We smile because that's what we do.", hungarian: "Mosolygunk, mert ezt tesszük.", start: 106.7, end: 109.8 },
              { text: "Thank you for the coffee, **sir**.", hungarian: "Köszönöm a kávét, uram.", start: 109.8, end: 113.6 },
              { text: "It burned my throat, it really hurt.", hungarian: "Leégette a torkomat, nagyon fájt.", start: 113.6, end: 116.8 }
            ]
          },
          {
            title: "Refrain", start: 117.3, end: 132.5,
            lines: [
              { text: "Walking down the street, FaceApp all around.", hungarian: "Sétálok az utcán, mindenütt FaceApp-os arcok.", start: 117.3, end: 132.5 },
              { text: "Everyone hides the pain they carry around.", hungarian: "Mindenki rejtegeti a fájdalmat, amit magával hord.", start: 117.3, end: 132.5 },
              { text: "I'm hiding all my little scars.", hungarian: "Én is rejtegetem az apró sebeimet.", start: 117.3, end: 132.5 },
              { text: "Maybe it's the fault in our stars.", hungarian: "Talán a csillagainkban van a hiba.", start: 117.3, end: 132.5 }
            ]
          },
          {
            title: "Verse 6", start: 138.6, end: 152.2,
            lines: [
              { text: "Keep your **youth** alive and bold.", hungarian: "Őrizd meg a fiatalságodat és légy bátor.", start: 138.6, end: 141.8 },
              { text: "Dreams are slowly being sold.", hungarian: "Az álmokat lassan eladják.", start: 141.8, end: 145.0 },
              { text: "That **divorced** man walks alone.", hungarian: "Az az elvált férfi egyedül sétál.", start: 145, end: 148.5 },
              { text: "Nobody calls his broken phone.", hungarian: "Senki sem hívja a törött telefonját.", start: 148.5, end: 152.2 }
            ]
          },
          {
            title: "Verse 7", start: 153.1, end: 166.7,
            lines: [
              { text: "An **elderly** man sits on a chair.", hungarian: "Egy idős férfi ül egy széken.", start: 153.1, end: 156.0 },
              { text: "People pass like he's not there.", hungarian: "Az emberek úgy mennek el mellette, mintha ott sem lenne.", start: 156, end: 160.0 },
              { text: "A **middle-aged** woman reads a book.", hungarian: "Egy középkorú nő könyvet olvas.", start: 160, end: 163.0 },
              { text: "No one stops to take a look.", hungarian: "Senki sem áll meg, hogy ránézzen.", start: 163, end: 166.7 }
            ]
          },
          {
            title: "Refrain", start: 166.7, end: 182.1,
            lines: [
              { text: "Walking down the street, FaceApp all around.", hungarian: "Sétálok az utcán, mindenütt FaceApp-os arcok.", start: 166.7, end: 182.1 },
              { text: "Everyone hides the pain they carry around.", hungarian: "Mindenki rejtegeti a fájdalmat, amit magával hord.", start: 166.7, end: 182.1 },
              { text: "I'm hiding all my little scars.", hungarian: "Én is rejtegetem az apró sebeimet.", start: 166.7, end: 182.1 },
              { text: "Maybe it's the fault in our stars.", hungarian: "Talán a csillagainkban van a hiba.", start: 166.7, end: 182.1 }
            ]
          },
          {
            title: "Verse 8", start: 197.0, end: 212.9,
            lines: [
              { text: "Keep it **personal** and sweet.", hungarian: "Maradjon személyes és kedves.", start: 197, end: 200.6 },
              { text: "Truth gets buried in the street.", hungarian: "Az igazság el van temetve az utcán.", start: 200.6, end: 204.5 },
              { text: "My **teenage** memories return.", hungarian: "Visszatérnek a tinédzser emlékeim.", start: 204.5, end: 207.7 },
              { text: "I still have so much to learn.", hungarian: "Még mindig olyan sokat kell tanulnom.", start: 207.7, end: 212.9 }
            ]
          },
          {
            title: "Verse 9", start: 214.0, end: 227.8,
            lines: [
              { text: "Hello **guys**, look at the sun!", hungarian: "Sziasztok srácok, nézzétek a napot!", start: 214, end: 217.2 },
              { text: "We keep smiling, one by one.", hungarian: "Tovább mosolygunk, egyenként.", start: 217.2, end: 221.0 },
              { text: "Where did you **grow up**?", hungarian: "Hol nőttél fel?", start: 221, end: 225.2 },
              { text: "Have you had enough?", hungarian: "Eleged lett?", start: 225.2, end: 227.8 }
            ]
          },
          {
            title: "Refrain", start: 227.9, end: 244.1,
            lines: [
              { text: "Walking down the street, FaceApp all around.", hungarian: "Sétálok az utcán, mindenütt FaceApp-os arcok.", start: 227.9, end: 244.1 },
              { text: "Everyone hides the pain they carry around.", hungarian: "Mindenki rejtegeti a fájdalmat, amit magával hord.", start: 227.9, end: 244.1 },
              { text: "I'm hiding all my little scars.", hungarian: "Én is rejtegetem az apró sebeimet.", start: 227.9, end: 244.1 },
              { text: "Maybe it's the fault in our stars.", hungarian: "Talán a csillagainkban van a hiba.", start: 227.9, end: 244.1 }
            ]
          }
        ]
      },
