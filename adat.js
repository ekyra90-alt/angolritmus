// ============================================================
// 🎵 DAL KONFIGURÁCIÓ — Hipochondria
// ============================================================

// ---------- ÁLTALÁNOS BEÁLLÍTÁSOK ----------

const SONG_TITLE = "Hipochondria";

// Az mp3 fájl neve/elérési útja (helyi fájl, ugyanabban a mappában, ahol a HTML-ek vannak)
const LOCAL_MP3_URL = "Hipochondria.mp3";

// Tartalék link, ha a helyi mp3 valamiért nem töltődik be
const FALLBACK_MP3_URL = "https://cdn.jsdelivr.net/gh/pintergabor/Hipochondria@main/Hipochondria.mp3";
...
// Megjegyzés: 03:24 (208s) után a dal még ismétli 2x a refrént kb. 4:39-ig,
// de erre nem küldtél pontos időbélyeget, így ezt a részt nem soroltam fel
// sor-szinten. Ha van rá pontos idő, szólj és hozzáadom.
