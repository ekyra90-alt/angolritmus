...
const TOPICS = [
  {
    ...
    songs: [
      ...
      },
      {
        ...
        cardsData: [
          { keyword: "fatigue", english: "While the heavy **fatigue** and silence bounds.", hungarian: "Míg a súlyos fáradtság és csend határolja.", startTime: 49.09, endTime: 56.37, verseIndex: 1 },
          { keyword: "phalange", english: "He broke a **phalange**, playing in the sand.", hungarian: "Eltörte egy ujjpercét, miközben a homokban játszott.", startTime: 59.70, endTime: 62.79, verseIndex: 1 },
          { keyword: "vertigo", english: "He feels a sharp **vertigo**, weak upon his knees.", hungarian: "Éles szédülést érez, gyengén a térdén.", startTime: 66.23, endTime: 69.54, verseIndex: 1 },
          { keyword: "bruise", english: "A woman sitting near me has a massive **bruise**.", hungarian: "Egy mellettem ülő nőnek hatalmas zúzódása van.", startTime: 109.54, endTime: 112.69, verseIndex: 2 },
          { keyword: "rash", english: "She has a red **rash** spreading on her arm.", hungarian: "Piros kiütés terjed a karján.", startTime: 115.78, endTime: 119.16, verseIndex: 2 },
          { keyword: "meniscus", english: "A runner by the window feels a sharp **meniscus** pain.", hungarian: "Az ablaknál álló futó éles meniszkusz fájdalmat érez.", startTime: 205.40, endTime: 208.73, verseIndex: 3 },
          { keyword: "patella", english: "His **patella** is swollen, making loud complaints.", hungarian: "A térdkalácsa duzzadt, hangosan panaszolva.", startTime: 211.90, endTime: 215.16, verseIndex: 3 },
          { keyword: "sternum", english: "Another patient tells the nurse about his **sternum** ache.", hungarian: "Egy másik beteg a szegycsontfájdalmáról beszél a nővérnek.", startTime: 218.27, endTime: 221.81, verseIndex: 4 },
          { keyword: "clavicle", english: "A basketball player holds his broken **clavicle** tight.", hungarian: "Egy kosárlabdázó szorosan tartja a törött kulcscsontját.", startTime: 232.03, endTime: 235.20, verseIndex: 5 },
          { keyword: "scapula", english: "His **scapula** is aching from the heavy fall.", hungarian: "Fáj a lapockája a nehéz eséstől.", startTime: 238.32, endTime: 241.49, verseIndex: 5 },
          { keyword: "tendon", english: "A dancer pulled a **tendon** while she tried to bend.", hungarian: "Egy táncos meghúzott egy inat, miközben hajolni próbált.", startTime: 327.86, endTime: 330.98, verseIndex: 6 },
          { keyword: "ligament", english: "A **ligament** is strained, she cannot walk away.", hungarian: "Egy szalag megfeszült/meghúzódott, nem tud elmenni.", startTime: 333.89, endTime: 337.08, verseIndex: 6 },
          { keyword: "cartilage", english: "The damaged **cartilage** is hurting in his knee.", hungarian: "A sérült porc fáj a térdében.", startTime: 342.63, endTime: 345.44, verseIndex: 7 },
          { keyword: "nausea", english: "He feels a deep **nausea** coming to his head.", hungarian: "Mély hányingert érez, ami a fejébe árad.", startTime: 348.61, endTime: 351.84, verseIndex: 7 },
          { keyword: "metatarsus", english: "A worker hurt his **metatarsus** dropping heavy wood.", hungarian: "Egy munkás megsértette a lábközépcsontját, amikor nehéz fát ejtett le.", startTime: 357.22, endTime: 400.35, verseIndex: 8 }
        ],

        songStructureData: [
          {
            title: "Refrén", start: 28.84, end: 56.37,
            lines: [
              { text: "Sitting in the waiting room, feeling so alone,", hungarian: "A váróteremben ülve, olyan magányosan,", start: 28.84, end: 34.94 },
              { text: "Waiting for the doctor, staring at my phone.", hungarian: "Orvosra várva, a telefonomat bámulva.", start: 34.94, end: 41.72 },
              { text: "Everyone is sick and making quiet sounds,", hungarian: "Mindenki beteg és halk hangokat ad ki,", start: 41.72, end: 49.09 },
              { text: "While the heavy **fatigue** and silence bounds.", hungarian: "Míg a súlyos fáradtság és csend határolja.", start: 49.09, end: 56.37, cardIndexes: [0] }
            ]
          },
          {
            title: "1. Versszak", start: 56.37, end: 69.54,
            lines: [
              { text: "A little boy is crying, holding his left hand,", hungarian: "Egy kisfiú sír, a bal kezét fogva,", start: 56.37, end: 59.70 },
              { text: "He broke a **phalange**, playing in the sand.", hungarian: "Eltörte egy ujjpercét, miközben a homokban játszott.", start: 59.70, end: 62.79, cardIndexes: [1] },
              { text: "An older man is coughing, breathing with a wheeze,", hungarian: "Egy idősebb férfi köhög, zihálva lélegzik,", start: 62.79, end: 66.23 },
              { text: "He feels a sharp **vertigo**, weak upon his knees.", hungarian: "Éles szédülést érez, gyengén a térdén.", start: 66.23, end: 69.54, cardIndexes: [2] }
            ]
          },
          {
            title: "2. Versszak", start: 69.54, end: 119.16,
            lines: [
              { text: "A woman sitting near me has a massive **bruise**,", hungarian: "Egy mellettem ülő nőnek hatalmas zúzódása van,", start: 69.54, end: 112.69, cardIndexes: [3] },
              { text: "She bumped into the table, nothing left to lose.", hungarian: "Nekiütközött az asztalnak, nincs vesztenivalója.", start: 112.69, end: 115.78 },
              { text: "She has a red **rash** spreading on her arm,", hungarian: "Piros kiütés terjed a karján,", start: 115.78, end: 119.16, cardIndexes: [4] },
              { text: "Hoping that the doctor keeps her safe from harm.", hungarian: "Bízva abban, hogy az orvos megóvja a bajtól.", start: 119.16, end: 124.50 }
            ]
          },
          {
            title: "Refrén (2.)", start: 124.50, end: 205.40,
            lines: [
              { text: "Sitting in the waiting room, feeling so alone,", hungarian: "A váróteremben ülve, olyan magányosan,", start: 124.50, end: 130.56 },
              { text: "Waiting for the doctor, staring at my phone.", hungarian: "Orvosra várva, a telefonomat bámulva.", start: 130.56, end: 137.47 },
              { text: "Everyone is sick and making quiet sounds,", hungarian: "Mindenki beteg és halk hangokat ad ki,", start: 137.47, end: 144.71 },
              { text: "While the heavy fatigue and silence bounds.", hungarian: "Míg a súlyos fáradtság és csend határolja.", start: 144.71, end: 205.40 }
            ]
          },
          {
            title: "3. Versszak", start: 205.40, end: 218.27,
            lines: [
              { text: "A runner by the window feels a sharp **meniscus** pain,", hungarian: "Az ablaknál álló futó éles meniszkusz fájdalmat érez,", start: 205.40, end: 208.73, cardIndexes: [5] },
              { text: "He twisted up his knee out running in the rain.", hungarian: "Kifordította a térdét az esőben futva.", start: 208.73, end: 211.90 },
              { text: "His **patella** is swollen, making loud complaints,", hungarian: "A térdkalácsa duzzadt, hangosan panaszolva,", start: 211.90, end: 215.16, cardIndexes: [6] },
              { text: "Looking at the ceiling like a pair of saints.", hungarian: "A plafont nézve, mint egy pár szent.", start: 215.16, end: 218.27 }
            ]
          },
          {
            title: "4. Versszak", start: 218.27, end: 232.03,
            lines: [
              { text: "Another patient tells the nurse about his **sternum** ache,", hungarian: "Egy másik beteg a szegycsontfájdalmáról beszél a nővérnek,", start: 218.27, end: 221.81, cardIndexes: [7] },
              { text: "He says his chest is hurting every breath he'll take.", hungarian: "Azt mondja, fáj a mellkasa minden egyes lélegzetvételnél.", start: 221.81, end: 224.80 },
              { text: "He feels a dull pressure right behind the bone,", hungarian: "Tompa nyomást érez közvetlenül a csont mögött,", start: 224.80, end: 227.98 },
              { text: "Sitting on the chair and waiting all alone.", hungarian: "A széken ülve és teljesen egyedül várva.", start: 227.98, end: 232.03 }
            ]
          },
          {
            title: "5. Versszak", start: 232.03, end: 246.43,
            lines: [
              { text: "A basketball player holds his broken **clavicle** tight,", hungarian: "Egy kosárlabdázó szorosan tartja a törött kulcscsontját,", start: 232.03, end: 235.20, cardIndexes: [8] },
              { text: "He crashed into a teammate in the game last night.", hungarian: "Összeütközött egy csapattárssal a tegnap esti meccsen.", start: 235.20, end: 238.32 },
              { text: "His **scapula** is aching from the heavy fall,", hungarian: "Fáj a lapockája a nehéz eséstől,", start: 238.32, end: 241.49, cardIndexes: [9] },
              { text: "Now he is the saddest person in the hall.", hungarian: "Most ő a legszomorúbb ember a teremben.", start: 241.49, end: 246.43 }
            ]
          },
          {
            title: "Refrén (3.)", start: 246.43, end: 327.86,
            lines: [
              { text: "Sitting in the waiting room, feeling so alone,", hungarian: "A váróteremben ülve, olyan magányosan,", start: 246.43, end: 253.05 },
              { text: "Waiting for the doctor, staring at my phone.", hungarian: "Orvosra várva, a telefonomat bámulva.", start: 253.05, end: 259.37 },
              { text: "Everyone is sick and making quiet sounds,", hungarian: "Mindenki beteg és halk hangokat ad ki,", start: 259.37, end: 307.07 },
              { text: "While the heavy fatigue and silence bounds.", hungarian: "Míg a súlyos fáradtság és csend határolja.", start: 307.07, end: 327.86 }
            ]
          },
          {
            title: "6. Versszak", start: 327.86, end: 342.63,
            lines: [
              { text: "A dancer pulled a **tendon** while she tried to bend,", hungarian: "Egy táncos meghúzott egy inat, miközben hajolni próbált,", start: 327.86, end: 330.98, cardIndexes: [10] },
              { text: "She hopes this painful visit comes to a quick end.", hungarian: "Reméli, hogy ez a fájdalmas látogatás hamar véget ér.", start: 330.98, end: 333.89 },
              { text: "A **ligament** is strained, she cannot walk away,", hungarian: "Egy szalag megfeszült, nem tud elmenni,", start: 333.89, end: 337.08, cardIndexes: [11] },
              { text: "Waiting for an answer on a rainy day.", hungarian: "Egy esős napon választ várva.", start: 337.08, end: 342.63 }
            ]
          },
          {
            title: "7. Versszak", start: 342.63, end: 357.22,
            lines: [
              { text: "The damaged **cartilage** is hurting in his knee,", hungarian: "A sérült porc fáj a térdében,", start: 342.63, end: 345.44, cardIndexes: [12] },
              { text: "He walks around the office very slowly.", hungarian: "Nagyon lassan sétálgat az irodában.", start: 345.44, end: 348.61 },
              { text: "He feels a deep **nausea** coming to his head,", hungarian: "Mély hányingert érez, ami a fejébe árad,", start: 348.61, end: 351.84, cardIndexes: [13] },
              { text: "Wishing he was resting safely in his bed.", hungarian: "Bárcsak biztonságban pihenne az ágyában.", start: 351.84, end: 357.22 }
            ]
          },
          {
            title: "8. Versszak", start: 357.22, end: 412.09,
            lines: [
              { text: "A worker hurt his **metatarsus** dropping heavy wood,", hungarian: "Egy munkás megsértette a lábközépcsontját, amikor nehéz fát ejtett le,", start: 357.22, end: 400.35, cardIndexes: [14] },
              { text: "He cannot stand as firmly as he always could.", hungarian: "Nem tud olyan szilárdan állni, mint mindig tudott.", start: 400.35, end: 403.51 },
              { text: "The waiting room is quiet, everybody waits,", hungarian: "A váróterem csendes, mindenki vár,", start: 403.51, end: 407.08 },
              { text: "Watching as the nurse is opening the gates.", hungarian: "Figyelve, amint a nővér nyitja az ajtókat/kapukat.", start: 407.08, end: 412.09 }
            ]
          }
        ]
      }
