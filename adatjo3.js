    ...
    songs: [
      {
        ...
        songStructureData: [
          ...
          },
          {
            ...
            lines: [
              { text: "I am terribly unwell tonight,", hungarian: "Szörnyen rosszul vagyok ma éjjel,", start: 43.0, end: 46.0 },
              { text: "My face is completely white.", hungarian: "Az arcom teljesen fehér.", start: 46.0, end: 49.9 },
              { text: "I suffer from a secret thing,", hungarian: "Egy titkos dologban szenvedek,", start: 49.9, end: 53.8 },
      ...
      },
      {
        ...
        cardsData: [
          { keyword: "fatigue", keywordHungarian: "kimerültség", english: "While the heavy **fatigue** and silence bounds.", hungarian: "Míg a nehéz **fáradtság** és csend körbezár.", startTime: 48.3, endTime: 55.7, verseIndex: 0 },
          { keyword: "phalange", keywordHungarian: "ujjpercsont", english: "He broke a **phalange**, playing in the sand.", hungarian: "Eltörött egy **ujjperc**e, miközben a homokban játszott.", startTime: 59.3, endTime: 62.6, verseIndex: 1 },
          { keyword: "vertigo", keywordHungarian: "szédülés", english: "He feels a sharp **vertigo**, weak upon his knees.", hungarian: "Erős **szédülés**t érez, gyenge a térde.", startTime: 66.3, endTime: 69.4, verseIndex: 1 },
          { keyword: "bruise", keywordHungarian: "véraláfutás", english: "A woman sitting near me has a massive **bruise**,", hungarian: "Egy mellettem ülő nőnek hatalmas **véraláfutás**a van,", startTime: 69.4, endTime: 72.5, verseIndex: 2 },
          { keyword: "rash", keywordHungarian: "kiütés", english: "She has a red **rash** spreading on her arm,", hungarian: "Egy vörös **kiütés** terjed a karján,", startTime: 75.6, endTime: 78.9, verseIndex: 2 },
          { keyword: "meniscus", keywordHungarian: "porcgyűrű", english: "A runner by the window feels a sharp **meniscus** pain,", hungarian: "Az ablaknál álló futó éles **meniszkusz**-fájdalmat érez,", startTime: 124.0, endTime: 128.4, verseIndex: 4 },
          { keyword: "patella", keywordHungarian: "térdkalács", english: "His **patella** is swollen, making loud complaints,", hungarian: "A **térdkalács**a megduzzadt, hangos panaszokat hallat,", startTime: 131.6, endTime: 134.9, verseIndex: 4 },
          { keyword: "sternum", keywordHungarian: "szegycsont", english: "Another patient tells the nurse about his **sternum** ache,", hungarian: "Egy másik beteg a **szegycsont**fájdalmáról beszél a nővérnek,", startTime: 138.2, endTime: 141.6, verseIndex: 5 },
          { keyword: "clavicle", keywordHungarian: "kulcscsont", english: "A basketball player holds his broken **clavicle** tight,", hungarian: "Egy kosárlabdázó szorosan fogja a törött **kulcscsont**át,", startTime: 151.7, endTime: 154.7, verseIndex: 6 },
          { keyword: "scapula", keywordHungarian: "lapocka", english: "His **scapula** is aching from the heavy fall,", hungarian: "A **lapocká**ja fáj a nehéz eséstől,", startTime: 157.7, endTime: 160.9, verseIndex: 6 },
          { keyword: "tendon", keywordHungarian: "ín", english: "A dancer pulled a **tendon** while she tried to bend,", hungarian: "Egy táncos meghúzott egy **ín**at, miközben hajolni próbált,", startTime: 207.5, endTime: 210.6, verseIndex: 8 },
          { keyword: "ligament", keywordHungarian: "szalag", english: "A **ligament** is strained, she cannot walk away,", hungarian: "Egy **szalag** megnyúlt, nem tud elmenni,", startTime: 213.7, endTime: 217.0, verseIndex: 8 },
          { keyword: "cartilage", keywordHungarian: "porc", english: "The damaged **cartilage** is hurting in his knee,", hungarian: "A károsodott **porc** fáj a térdében,", startTime: 222.3, endTime: 225.2, verseIndex: 9 },
          { keyword: "nausea", keywordHungarian: "hányinger", english: "He feels a deep **nausea** coming to his head,", hungarian: "Mély **hányinger** önti el a fejét,", startTime: 228.4, endTime: 231.9, verseIndex: 9 },
          { keyword: "metatarsus", keywordHungarian: "lábközépcsont", english: "A worker hurt his **metatarsus** dropping heavy wood,", hungarian: "Egy munkás megsértette a **lábközépcsont**át, amikor nehéz fát ejtett le,", startTime: 236.5, endTime: 240.0, verseIndex: 10 }
        ],
        ...
        songStructureData: [
          ...
          },
          {
            ...
            lines: [
              ...
              { text: "An older man is coughing, breathing with a wheeze,", hungarian: "Egy idősebb férfi köhög, zihálva lélegzik,", start: 62.6, end: 66.3 },
              { text: "He feels a sharp **vertigo**, weak upon his knees.", hungarian: "Erős **szédülés**t érez, gyenge a térde.", start: 66.3, end: 69.4 }
            ]
          },
          {
